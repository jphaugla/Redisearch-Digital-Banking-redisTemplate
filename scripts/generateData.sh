...
# with ssl
# curl -cacert='..//src/main/resources/ssl/proxy-cert.pem' 'http://localhost:8080/generateData?noOfCustomers=500&noOfTransactions=10000&noOfDays=5&key_suffix=J&pipelined=false'
